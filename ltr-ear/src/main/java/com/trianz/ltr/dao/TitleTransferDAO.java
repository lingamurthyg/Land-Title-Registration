...
/**
 * TitleTransferDAO - Cloud-ready JDBC DAO for TITLE_TRANSFER_HISTORY table.
 *
...
public class TitleTransferDAO {
    ...
    public CompletableFuture<Long> insertAsync(TitleTransfer tr) {
    ...
    public CompletableFuture<List<TitleTransfer>> findByTitleNumberAsync(String titleNumber) {
        return CompletableFuture.supplyAsync(() -> {
            try {
    ...
    public static void shutdown() {
        ...
        LOGGER.info("TitleTransferDAO executor service shut down");
    }
}
